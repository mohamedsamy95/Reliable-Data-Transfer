...
public class sendPacketThreadGBN implements Runnable {
	...
	int packetsize;
	int id;
	sendPacketThreadGBN(Main main,DatagramPacket packet,DatagramSocket socket,int seqnum, Semaphore lock,Semaphore lock2, int size,int id){
		this.main = main;
		this.packet = packet;
		this.socket = socket;
		this.seqnum = seqnum;
